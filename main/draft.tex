...
\setlength{\topsep}{0pt}              
\usepackage[pdftex,unicode,colorlinks=false,urlcolor=blue,citecolor=black,hidelinks]{hyperref}
\usepackage{bbm}
\usepackage{tabularx}
...
%Third, subsample analysis suggest that the most important driver of stronger impact of shotgun marriages on college graduates relative to non-college graduates can be rationalized by larger weight of child quality in their utility.
%[Last, the model predicts decline in probabilities of unexpected pregnancies since 1980: the model matching fertility / marriage / divorce profiles from Census of 1980 predicts larger chances of unplanned pregnancies among all income and age groups.]
