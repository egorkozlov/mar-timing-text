...
%[Paragraph 1: is shotgun marriage still a thing?]
Term ``shotgun marriage'' is traditionally used to describe situations when having a baby triggers marriage of a couple. This practice does not solely refer back to more conservative times: in the modern US data around one-quarter of married women of age 21--40 had their first birth before or at the year of their first marriage\footnote{SIPP 2014}. And, although it seems that abortion and contraception access would provide people with more choice, in the data such couples still look like something pushed them to marry each other. In particular, their marriages appear less stable over time: despite of being less than quarter of the population shotgun marriage couples account for more than one-third of divorces\footnote{ACS 2009--2017}.
...
%[Paragraph 5: empirical findings --- main difference and subpopulations]
...
%[Paragraph 6: empirical findings --- duration, step-children, lf and child development outcomes]
Investigating the data further leads to few additional insights. First, different timing of marriage and marriage duration at the moment of survey between the two groups does not seem to be an important contributor to the difference. Second, the divorces are concentrated around the time the child starts going to school. Third, for the cases when we can recover whether the child is step or own, this status does not affect the marriage duration, moreover, less than fifteen percent of the couples I observe seem to have step-children as I exclude those women who had their births long ago after their marriage. [SIPP multipartner fertility data confirm these findings?]
...
%[Paragraph 8: model --- what I get from it, mechanics and anatomy]
...
%[Paragraph 12: not a paragraph, just table of contents]
