...
% There is a huge social issue of single mothers
% You typically associate it with unplanned teenage pregnancies of low-income and low-education people
% But looking at just single mothers or young couples is an understatement
% Unplanned pregnancy expresses itself even for married people: not all marriages are created equal
% In later ages unplanned pregnancies force couple to marry
% 
% Even for college 
% In more adult age this is pronounced by shotgun marriage
% Chetty stuff: share of single mothers is the best predictor of inequality and so on
...
\begin{center}
\includegraphics[width=0.85\linewidth]{share_div_march5.eps}
\end{center}
\end{frame}
...
\frametitle{Hazards}
\begin{center}
\includegraphics[width=0.85\linewidth]{haz_kf_march5.eps}
\end{center}
\end{frame}
...
\frametitle{Shares}
\begin{center}
\includegraphics[width=0.85\linewidth]{share_kj_march5.eps}
\end{center}
\end{frame}
...
%
%\begin{frame}
%\frametitle{[Distribution of age at shotgun marriage in my def]}
%
%\end{frame}
...
\pause  
    ...
    \node [block, above left   = 1.0 cm and -0.75 cm of 2] (4) {\,\, Single male $(m,s)$\,\,};
    \node [block, above left   = 1.6 cm and -0.75 cm of 2] (4-sm) {Single mother $(f,sk)$};
	\node [block, above right   = 1.0 cm and -0.75 cm of 3] (6) {\,\, Single male $(m,s)$\,\,};
    \node [block, above right   = 1.6 cm and -0.75 cm of 3] (6-f) {\,Single female $(f,s)$\,};   
...
\begin{frame}[label=pic0]
\frametitle{In One Picture (Old \& Extended Version)}
\begin{center}
\includegraphics[width=0.85\linewidth]{diff_dt_h.pdf}
\end{center}
\end{frame}
